...
public class TestLitleOnline {
    ...
    public void testActivateReversal() throws Exception {
        ...
        when(
                mockedCommunication
                        .requestToServer(
                                matches(".*?<litleOnlineRequest.*?<activateReversal reportGroup=\"Default Report Group\" id=\"id\">"
    ...
    public void testDeactivateReversal() throws Exception {
        ...
        when(
                mockedCommunication
                        .requestToServer(
                                matches(".*?<litleOnlineRequest.*?<deactivateReversal reportGroup=\"Default Report Group\" id=\"id\">"
                                		+ "<litleTxnId>123</litleTxnId>"
                                		+ "<card>"
                                		+ "<type>GC</type>"
                                		+ "<number>5400000000000000</number>"
    ...
    public void testDeActivateReversalWithOverrides() throws Exception {
        ...
        when(
                mockedCommunication
                        .requestToServer(
                                matches(".*?<litleOnlineRequest merchantId=\"905\".*?xmlns=\"http://www.litle.com/schema\">.*?"
    ...
    public void testLoadReversal() throws Exception {
        ...
        when(
                mockedCommunication
                        .requestToServer(
                                matches(".*?<litleOnlineRequest.*?<loadReversal reportGroup=\"Default Report Group\" id=\"id\">"
                                		+ "<litleTxnId>123</litleTxnId>"
                                		+ "<card>"
                                		+ "<type>GC</type>"
                                		+ "<number>5400000000000000</number>"
    ...
    public void testUnLoadReversal() throws Exception {
        ...
        when(
                mockedCommunication
                        .requestToServer(
                                matches(".*?<litleOnlineRequest.*?<unloadReversal reportGroup=\"Default Report Group\" id=\"id\">"
                                		+ "<litleTxnId>123</litleTxnId>"
                                		+ "<card>"
                                		+ "<type>GC</type>"
                                		+ "<number>5400000000000000</number>"
